...
from opencood.data_utils.datasets.camera_intermediate_fusion_dataset_dair import CameraIntermediateFusionDatasetDAIR
...
__all__ = {
    ...
    "CameraIntermediateFusionDatasetDAIR":CameraIntermediateFusionDatasetDAIR
}
